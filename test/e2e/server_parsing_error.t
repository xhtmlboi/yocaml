Server returns 500 and detailed parsing error

  $ pkill -f "server_error.exe 8090" 2>/dev/null || true
  $ fuser -k 8090/tcp >/dev/null 2>&1 || true

  $ ./bin/server_error.exe 8090 content_pp_errors/parsing_error.md >/dev/null 2>&1 &
